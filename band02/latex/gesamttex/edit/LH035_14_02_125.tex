...
\edtext{$\displaystyle \frac{p}{p + \pi}v \, \sqcap \, (v)$. Or}{\lemma{$\displaystyle \frac{p}{p + \pi}v \, \sqcap \, (v)$}\Bfootnote{\textit{(1)}\ par consequent \textit{(2)}\ . Or \textit{L}}}
...
rest\'{e}e
\edtext{$\displaystyle \frac{p^2}{p^2 + 2p \pi + \pi ^2} v$ ou la premiere vistesse multipli\'{e}e par}{\lemma{\hspace{1.8mm}15--S. 334.3 \hspace{1.8mm}$\displaystyle \frac{p^2}{p^2 + 2p \pi + \pi ^2} v$}\killnumber\Bfootnote{\textit{(1)}\ ou le quarr\'{e} de $\displaystyle \frac{p}{p + \pi}$ \textit{(2)}\ . En continuant le m\^{e}me calcul on trouuera que la vistesse rest\'{e}e apr\`{e}s avoir pouss\'{e} le troisieme moulinet sera la premiere vi \textit{(3)}\ ou la premiere [...] apr\`{e}s \textbar\ le deuxieme choc \textit{erg.}\ \textbar\ sera [...] c'est \`{a} dire \textit{(a)}\ qu'elle sera \`{a} la premi\`{e}re comme \textit{(b)}\ la premiere $\displaystyle v$, \textit{L}}}
\pend
\newpage
...
width=0.36\textwidth]
{images/lh0351402_125-d1.pdf}, \hspace{19mm}{[\textit{Fig. 4}]}]
\noindent
Nec tantum considerandum est, quod aliquot \edtext{globuli retineantur}{\lemma{21f. \hspace{1.8mm}globuli}\killnumber\Bfootnote{\textit{(1)}\ impingunt \textit{(2)}\ retineantur, \textit{L}}},
sed et quod inter \edtext{hos aliosque}{\lemma{22 \hspace{1.8mm}hos}\killnumber\Bfootnote{\textit{(1)}\ aliquosque \textit{(2)}\ aliosque \textit{L}}}
aliqua conjunctio sive glutinositas, ut alter sine altero non facile moveatur.
Sed quanta aut qualiacunque haec sint semper eodem modo intelligi {possunt\reversemarginpar\marginnote{\scriptsize\hspace{-13mm}25}}. Itaque cognita liquoris specie quaeritur tum de quantitate ictus, tum de numero 
supervenientium ictuum. Jam quanto celerior est liquidi motus eo plures eodem tempore su-
\end{window}
\pend
\newpage
\pstart
\noindent
%\begin{wrapfigure}[10]{l}{0.36\textwidth}    
...
%supervenientium ictuum. Jam quanto celerior est liquidi motus eo plures eodem tempore superveniunt ictus, sunt ergo \edtext{ictus tam magnitudine}{\lemma{ictus}\Bfootnote{\textit{(1)}\ in duplicata celeritatum. Primum ergo movetur corpus \textit{(2)}\ tam magnitudine [...] celeritatum. \textit{L}}}%
perveniunt ictus, sunt \edtext{ergo ictus tam magnitudine quam numero ut celeritates adeoque in duplicata celeritatum}{\lemma{ergo ictus}\Bfootnote{\textit{(1)}\ in duplicata celeritatum. Primum ergo movetur corpus \textit{(2)}\ tam magnitudine [...] celeritatum. \textit{L}}}. 
...
\textit{L}}}\edtext{}{\Bfootnote{$\displaystyle 6$ \textit{\ L \"{a}ndert Hrsg.}}}Et ita continuandus semper esset motus si corpusculis $\displaystyle l$ ipsum $\displaystyle m$ velut crescere fingamus pulvisculis quodammodo collectis, sed 
