...
\pstart%
\noindent%
\lbrack\textit{Nachfolgenden Textabschnitt (bis zum Ende von N.~12\textsubscript{3}) hat Leibniz im unteren Teil von Bl.~8~v\textsuperscript{o}\! als neuen Schluss der Reinschrift \textit{l} verfasst (\textit{Lil}):}\rbrack\ %%%% SANASTO TÃHÃN ASTI LISÃTTY
\pend%
\vspace{0.5em}%
\pstart%
\noindent%
